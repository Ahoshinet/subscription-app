...
サブスクリプションサービスを一元管理するためのモバイルアプリケーションです。**React Native (Expo)** で構築されています。
...
| プラットフォーム | 最小対応バージョン | 推奨・実機検証済み |
|---|---|---|
| Android | Android 7.0（API レベル 24）以上 | Android 12L（API レベル 32）以上 |
| iOS | iOS 16.4 以上 | iOS 26 以上 |

最小対応バージョンは v1.0.0 の配布物に設定されている値です。推奨
バージョンは、このリリースで実機検証を完了した環境に基づいています。
Android の API レベル 32 は Android 12L に該当します。

## セットアップ

### 前提条件

- [Node.js](https://nodejs.org/) (v22.23.1 以上)
- [pnpm](https://pnpm.io/) (v11.17.0 以上)
