            ...
            <View className="flex-1 bg-neutral-50 dark:bg-neutral-950 pt-6">
                <ScrollView className="flex-1 px-4">
                    {methods.length === 0 ? (
                        ...
                        <View key="billing-list" className="bg-white dark:bg-[#1C1C1E] rounded-2xl overflow-hidden shadow-sm shadow-neutral-200/50 dark:shadow-none border border-neutral-200/50 dark:border-white/10 mb-6">
